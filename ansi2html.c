    ...
    while (i < size) {
        ...
        if (ch == 0x1B && i + 1 < size && data[i + 1] == '[') {
            ...
            if (utf8_len > 0 && i + utf8_len <= size) {
                ...
                /* Invalid UTF-8 start byte or truncated sequence - skip it */
                i++;
            }
        } else {
...
static void output_html(Screen *screen) {
    ...
    printf("}\n");
     ...
     printf("}\n");
       ...
       printf("  -webkit-transform: translate3d(0, 0, 0);\n");
       printf("  transform: translate3d(0, 0, 0);\n");
       printf("  will-change: transform;\n");
       printf("}\n");
       ...
       printf("  -webkit-transform: translate3d(0, 0, 0);\n");
       printf("  transform: translate3d(0, 0, 0);\n");
       printf("  backface-visibility: hidden;\n");
       printf("  perspective: 1000;\n");
      printf("}\n");
